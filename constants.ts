...
export const INITIAL_USERS: User[] = [
    ...
    { id: 't-user-04', name: 'فهمي الجرافي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-05', name: 'عاصم المنعي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-06', name: 'عبد الرزاق صبيح', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-07', name: 'جمال الرديني', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-08', name: 'إيمان قطيش', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-09', name: 'وفاء الصلوي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-10', name: 'إيمان النصيف', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-11', name: 'عبد السلام المعدني', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-12', name: 'علي عامر', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-13', name: 'محمد المشرع', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-14', name: 'إيمان العبسي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-15', name: 'رانيا العزي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-16', name: 'هدى الصغير', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-17', name: 'أشواق المخلافي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-18', name: 'عائشة العريقي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-19', name: 'ألطاف جار الله', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-20', name: 'هناء الحيجنة', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-21', name: 'رحاب العيفري', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-22', name: 'ضحى القباطي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-23', name: 'خلود صلاح', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-24', name: 'هند الحبابي', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
    { id: 't-user-25', name: 'ناديا الورد', code: '1122025', permissions: ['create_self_evaluation'], managedTeacherIds: [] },
];
